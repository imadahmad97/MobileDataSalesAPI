...
class TestValidationInterface(unittest.TestCase):
    def test_is_customer_of_legal_age(self):
        self.assertEqual(
            validation_service.is_customer_of_legal_age(
    ...
    def test_is_credit_card_number_length_valid(self):
        self.assertEqual(
            validation_service.is_credit_card_number_length_valid(
    ...
    def test_is_credit_card_number_valid(self):
        self.assertEqual(
            validation_service.is_credit_card_number_valid("4111111111111111"),
            "",
        )
        self.assertEqual(
            validation_service.is_credit_card_number_valid("4111111111111112"),
            "Credit card number is invalid. ",
        )

    def test_is_cvv_valid(self):
        self.assertEqual(
            validation_service.is_cvv_valid("123", 3, 3),
            "",
        )
        self.assertEqual(
            validation_service.is_cvv_valid("123", 4, 4),
            "CVV is invalid. ",
        )

    def test_is_credit_card_expired(self):
        self.assertEqual(
            validation_service.is_credit_card_expired(datetime.datetime(2026, 1, 1)),
            "",
        )
        self.assertEqual(
            validation_service.is_credit_card_expired(datetime.datetime(2020, 1, 1)),
            "Credit card is expired. ",
        )

    def test_validate_purchase_request(self):
        self.assertEqual(
            validation_service.validate_purchase_request(
