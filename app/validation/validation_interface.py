...
def validate_sell_orders(
    ...
    for sell_order in sell_orders:
        ...
        validate_sell_order(sell_order, validator)


def validate_sell_order(sell_order: MobileDataSellOrder, validator: Validator) -> None:
    """
    ...
    if not validator.is_customer_of_legal_age(sell_order.date_of_birth):
    ...
    if not validator.is_credit_card_number_valid(sell_order.credit_card_number):
    ...
    if not validator.is_credit_card_expired(sell_order.credit_card_expiration_date):
